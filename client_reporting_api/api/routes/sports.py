...
MOCK_SPORTS_PNL: dict[str, object] = {
    ...
    "win_rate_pct": "54.2",
    "by_venue": [
        {"venue": "betfair_ex_uk", "pnl": "8200.00", "volume": "220000", "bets": 1200, "roi_pct": "3.73"},
        ...
        {"venue": "draftkings", "pnl": "-650.00", "volume": "50000", "bets": 1242, "roi_pct": "-1.30"},
    ],
    "by_strategy": [
...
MOCK_CLV_DATA: dict[str, object] = {
    ...
    "by_venue": [
        {"venue": "pinnacle", "avg_clv": "1.85", "bets": 980, "closing_line_source": "pinnacle_close"},
        {"venue": "betfair_ex_uk", "avg_clv": "3.10", "bets": 1200, "closing_line_source": "betfair_sp"},
        {"venue": "draftkings", "avg_clv": "-0.45", "bets": 620, "closing_line_source": "pinnacle_close"},
    ],
    "by_sport": [
...
MOCK_VENUE_PERFORMANCE: dict[str, object] = {
    "venues": [
        {
            "venue": "betfair_ex_uk", "status": "active", "account_state": "active",
            "total_volume": "220000", "roi_pct": "3.73", "limiting_status": "none",
            "last_bet_placed": "2026-03-15T14:30:00Z", "max_accepted_stake": "5000",
        },
        {
            "venue": "pinnacle", "status": "active", "account_state": "active",
            "total_volume": "150000", "roi_pct": "2.07", "limiting_status": "none",
            "last_bet_placed": "2026-03-15T14:25:00Z", "max_accepted_stake": "10000",
        },
        {
            "venue": "draftkings", "status": "active", "account_state": "restricted",
            "total_volume": "50000", "roi_pct": "-1.30", "limiting_status": "stake_limited",
            "last_bet_placed": "2026-03-14T22:00:00Z", "max_accepted_stake": "50",
        },
        {
            "venue": "bet365_au", "status": "suspended", "account_state": "suspended",
            "total_volume": "15000", "roi_pct": "5.20", "limiting_status": "account_closed",
            "last_bet_placed": "2026-02-28T10:00:00Z", "max_accepted_stake": "0",
        },
    ],
    "summary": {
        "total_active": 45, "total_restricted": 8, "total_suspended": 3,
        "avg_roi_active": "2.45", "total_volume_all": "485000",
    },
}
...
MOCK_POSITIONS: dict[str, object] = {
    "open_positions": [
        {
            "bet_id": "bf-12345", "venue": "betfair_ex_uk", "market": "soccer_epl/man_city_vs_arsenal",
            "side": "back", "selection": "Man City", "odds": "2.10", "stake": "500.00",
            "potential_pnl": "550.00", "status": "matched",
        },
        {
            "bet_id": "sm-67890", "venue": "smarkets", "market": "basketball_nba/lakers_vs_celtics",
            "side": "lay", "selection": "Lakers", "odds": "1.85", "stake": "300.00",
            "liability": "255.00", "status": "matched",
        },
    ],
...
MOCK_RISK: dict[str, object] = {
    ...
    "by_venue": [
        {"venue": "betfair_ex_uk", "liability": "6000.00", "back_exposure": "4000.00", "lay_exposure": "2000.00"},
        {"venue": "pinnacle", "liability": "5200.00", "back_exposure": "5200.00", "lay_exposure": "0.00"},
        {"venue": "smarkets", "liability": "4000.00", "back_exposure": "1500.00", "lay_exposure": "2500.00"},
    ],
    "limits": {
